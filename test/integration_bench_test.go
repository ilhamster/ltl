...
func BenchmarkStream_1_1_100(b *testing.B) {
	stream(b, streamExpr1, input, 100, 5*100+(100-1), kNoProf)
}

func BenchmarkStream_1_1_1000(b *testing.B) {
	stream(b, streamExpr1, input, 1000, 5*1000+(1000-1), kNoProf)
}

func BenchmarkStream_1_1_10000(b *testing.B) {
	stream(b, streamExpr1, input, 10000, 5*10000+(10000-1), kNoProf)
}

func BenchmarkStream_2_1_100(b *testing.B) {
	stream(b, streamExpr2, input, 100, 3*100+(2*(100-1)), kNoProf)
}

func BenchmarkStream_2_1_1000(b *testing.B) {
	stream(b, streamExpr2, input, 1000, 3*1000+(2*(1000-1)), kNoProf)
}

func BenchmarkStream_3_1_100(b *testing.B) {
	stream(b, streamExpr3, input, 100, 2*100, kNoProf)
}

func BenchmarkStream_3_1_1000(b *testing.B) {
	stream(b, streamExpr3, input, 1000, 2*1000, kNoProf)
}

func BenchmarkOnce_1_1_100(b *testing.B) {
	once(b, onceExpr1, input, 100, 5*100-1, kNoProf)
}

func BenchmarkOnce_1_1_1000(b *testing.B) {
	once(b, onceExpr1, input, 1000, 5*1000-1, kNoProf)
}

func BenchmarkOnce_1_1_10000(b *testing.B) {
	once(b, onceExpr1, input, 10000, 5*10000-1, kNoProf)
}
